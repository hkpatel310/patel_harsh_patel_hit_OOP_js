...
var _multiStepFormJs = require("../modules/MultiStepForm.js");
new (0, _multiStepFormJs.MultiStepForm)("multistep-form");

},{"../modules/MultiStepForm.js":"mZQf6"}],"mZQf6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MultiStepForm", ()=>MultiStepForm);
class MultiStepForm {
    constructor(formId){
    ...
    initializeButtons() {
        for (const btn of this.nextButtons)btn.addEventListener("click", (e)=>{
            e.preventDefault();
            let currentPage = this.getCurrentPage();
            this.goToPage(currentPage + 1);
        });
        for (const btn of this.prevButtons)btn.addEventListener("click", (e)=>{
            e.preventDefault();
            let currentPage = this.getCurrentPage();
            this.goToPage(currentPage - 1);
        });
    ...
    goToPage(targetPage) {
        ...
        for (const page of this.pages){
            ...
            if (parseInt(page.dataset.page, 10) === targetPage) page.classList.add("active");
        }
    ...
    updateProgressBar() {
        ...
        for (const step of allSteps){
            ...
            if (parseInt(step.dataset.page, 10) <= currentPage) step.classList.add("active");
        }
    }
    populateYearOptions() {
...
},{}]},["kzbYw","bDbGG"], "bDbGG", "parcelRequire276e")
